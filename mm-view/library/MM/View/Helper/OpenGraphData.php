...
class OpenGraphData extends Helper implements \Countable
{
    ...
    protected $_whitelist = [
        ...
        'fb:app_id'=>1,
        // basic
        "og:type"=>1, "og:url"=>1, "og:site_name"=>1, "og:title"=>1,
        "og:description"=>1, "og:image"=>1,
        // aditional
        "og:locale"=>1, "og:locale:alternate"=>1,
        // image (url je kesovana)
        "og:image:url"=>1, "og:image:secure_url"=>1, "og:image:type"=>1,
        "og:image:width"=>1, "og:image:height"=>1,
        // video
        "og:video"=>1, "og:video:url"=>1, "og:video:secure_url"=>1,
        "og:video:type"=>1, "og:video:width"=>1, "og:video:height"=>1,
    ];
