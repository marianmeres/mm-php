...
if (!defined("MM_SIMPLECACHE_DB_VENDOR")) {
    define(
        "MM_SIMPLECACHE_DB_VENDOR",
        getEnvFromPhpUnitXmlConfig('MM_SIMPLECACHE_DB_VENDOR', "sqlite")
    );
}

// tu si to konverneme na json, lebo potrebujeme primitivny typ do konstatny
if (!defined('MM_SIMPLECACHE_PDO_JSON_CONFIG')) {
    define('MM_SIMPLECACHE_PDO_JSON_CONFIG', json_encode($config[MM_SIMPLECACHE_DB_VENDOR]));
}
