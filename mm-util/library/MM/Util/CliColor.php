...
class CliColor
{
     ...
     * @var array
     */
    protected static $_ANSI_CODES = array(
        "off"        => 0,
        "bold"       => 1,
        "italic"     => 3,
        "underline"  => 4,
     ...
     * @return string
     */
    public static function red($s) {return self::set($s, 'red');}

    /**
     * @param $s
     * @return string
     */
    public static function green($s) {return self::set($s, 'green');}

    /**
     * @param $s
     * @return string
     */
    public static function yellow($s) {return self::set($s, 'yellow');}

    /**
     * @param $s
     * @return string
     */
    public static function blue($s) {return self::set($s, 'blue');}

    /**
     * @param $s
     * @return string
     */
    public static function magenta($s) {return self::set($s, 'magenta');}

    /**
     * @param $s
     * @return string
     */
    public static function cyan($s) {return self::set($s, 'cyan');}

    /**
     * @param $s
     * @return string
     */
    public static function white($s) {return self::set($s, 'white');}
