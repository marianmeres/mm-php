...
class Response implements \ArrayAccess
{
    ...
    public function setCookie($name, $value, array $options = array())
    {
        ...
        foreach (array('secure', 'httponly') as $_key) {
     ...
     * @return $this
     */
    public function unsetCookie($name, array $options = array())
    {
    ...
    {
        return sprintf(
            "HTTP/$version %d %s", $this->getStatusCode(), $this->getStatusCodeMessage()
        );
    }
