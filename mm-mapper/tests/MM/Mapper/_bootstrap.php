...
set_include_path(implode(PATH_SEPARATOR, array(
    ...
    realpath(__DIR__ . "/../../../../mm-model/library"), // mm-model
)));
...
if (!defined("MM_MAPPER_DB_VENDOR")) {
    define(
    "MM_MAPPER_DB_VENDOR",
    getEnvFromPhpUnitXmlConfig('MM_MAPPER_DB_VENDOR', "sqlite")
    );
}

// tu si to konverneme na json, lebo potrebujeme primitivny typ do konstatny
if (!defined('MM_MAPPER_PDO_JSON_CONFIG')) {
    define('MM_MAPPER_PDO_JSON_CONFIG', json_encode($config[MM_MAPPER_DB_VENDOR]));
}