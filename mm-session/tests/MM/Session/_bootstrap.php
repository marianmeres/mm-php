...
if (!defined("MM_SESSION_DB_VENDOR")) {
    define(
        "MM_SESSION_DB_VENDOR",
        getEnvFromPhpUnitXmlConfig('MM_SESSION_DB_VENDOR', "sqlite")
    );
}

// tu si to konverneme na json, lebo potrebujeme primitivny typ do konstatny
if (!defined('MM_SESSION_PDO_JSON_CONFIG')) {
    define('MM_SESSION_PDO_JSON_CONFIG', json_encode($config[MM_SESSION_DB_VENDOR]));
}
